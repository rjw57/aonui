...
Usage:
        ...
        go sync [-basedir directory] [-highres] [-maxruns number]
...
Filter and sort a GRIB2's inventory into "Tawhiri order"

Usage:

        go inv [-nosort] [-nofilter] gribfile
...
Usage:
        ...
        go reorder ingribfile outgribfile
...
Extract binary data in "Tawhiri order" from a GRIB2 message

Usage:

        go extract [-tmpdir directory] <ingrib> <outbin>
